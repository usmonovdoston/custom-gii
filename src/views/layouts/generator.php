...
/* @var $generators \usmonovdoston\customGii\Generator[] */
/* @var $activeGenerator \usmonovdoston\customGii\Generator */
/* @var $content string */

$generators = Yii::$app->controller->module->generators;
$activeGenerator = Yii::$app->controller->generator;
?>
<?php $this->beginContent('@vendor/usmonovdoston/custom-gii/src/views/layouts/main.php'); ?>
<div class="row">
