...
namespace usmonovdoston\customGii;
 ...
 *     'bootstrap' => ['gii'],
 *     'modules' => [
 *         'gii' => ['class' => 'usmonovdoston\customGii\Module'],
 *     ],
 * ]
 * ~~~
 *
...
class Module extends \yii\base\Module implements BootstrapInterface
{
     ...
     * {@inheritdoc}
     */
    public $controllerNamespace = 'usmonovdoston\customGii\controllers';
    /**
    ...
    public function bootstrap($app)
    {
        if ($app instanceof \yii\web\Application) {
            ...
            $app->controllerMap[$this->id] = [
                'class' => 'usmonovdoston\customGii\console\GenerateController',
    ...
    {
        return [
            'model' => ['class' => 'usmonovdoston\customGii\generators\model\Generator'],
            'crud' => ['class' => 'usmonovdoston\customGii\generators\crud\Generator'],
            'ajaxcrud' => ['class' => 'usmonovdoston\customGii\generators\ajaxcrud\Generator'],
            'controller' => ['class' => 'usmonovdoston\customGii\generators\controller\Generator'],
            'form' => ['class' => 'usmonovdoston\customGii\generators\form\Generator'],
            'module' => ['class' => 'usmonovdoston\customGii\generators\module\Generator'],
            'extension' => ['class' => 'usmonovdoston\customGii\generators\extension\Generator'],
        ];
    }
